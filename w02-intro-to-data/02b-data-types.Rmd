...
* __Continuous__ variables are not countable and have an infinite number of possible values. Any decimal value make sense. Continuous variables can be measured to a certain precision, e.g. days, hours, minutes, seconds, ... 
    
    e.g. `weight`, `commute_time`

--

* __Discrete__ variables have a finite or countable number of possible values. 
...
Classify variables in the `mariokart` dataset. 

Numerical: duration, n_bids, start_pr, ship_pr, 
total_pr, seller_rate, wheels

Categorical: id, cond, ship_sp, stock_photo, title

--

- character: id
- integer: duration, n_bids, seller_rate, wheels
- double: start_pr, ship_pr, total_pr
- factor: cond, ship_sp, title
- logical: stock_photo
