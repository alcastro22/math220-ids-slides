...
When using bootstrap method, we use the function `slice_sample(dataset, n = #)` to take a random sample of size `n` from our `dataset`. Recall that this generates a tibble with the randomly selected values (rows).  
