...
If you open up a file and are using a package, RStudio will tell you that you have not installed the package.
...
__Good part:__ We are able to do pretty much anything in R because someone from around the world has developed the package and shared it. 
