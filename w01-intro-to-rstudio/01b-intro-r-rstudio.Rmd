...
RStudio performs operations as a calculator would do. 
...
RStudio follows the order of operations as a calculator would do too. 
...
If you want addition or subtraction to be done before any of the prior operations (mult, div, exp, ...) then you must put parenthesis around the values.
